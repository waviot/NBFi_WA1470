...
#define WA_IRQ_Pin 		GPIO_PIN_0
#define WA_IRQ_EXTI_IRQn 	EXTI0_1_IRQn
#define WA_EXT_IRQHandler       EXTI0_1_IRQHandler
#define WA_CS_GPIO_Port 	GPIOB
#define WA_CS_Pin 		GPIO_PIN_1
#define WA_TCXO_GPIO_Port 	GPIOA
#define WA_TCXO_Pin 		GPIO_PIN_8
...
void wa1470_HAL_GPIO_Init()
{
  ...
  GPIO_InitStruct.Pin = WA_TCXO_Pin;    
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(WA_TCXO_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = WA_DFT_EN_Pin;    
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(WA_DFT_EN_GPIO_Port, &GPIO_InitStruct);
