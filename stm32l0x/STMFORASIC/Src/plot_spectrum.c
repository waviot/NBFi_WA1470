...
#ifdef WA1471
#define    wa147xrfe_set_rx_gain         wa1471rfe_set_rx_gain
#define    wa147xdem_set_bitrate         wa1471dem_set_bitrate
#else
#define    wa147xrfe_set_rx_gain         wa1470rfe_set_rx_gain
...
void plot_spectrum()
{
      ...
      if(!RS485_UART_is_empty())
      {
        ...
        case 0x2c:
          ...
          wa147xrfe_set_rx_gain(rfe_rx_total_vga_gain + 3);
        ...
        case 'z':
          ...
          break;  
        case '5':
          wa147xdem_set_bitrate(DBPSK_50_PROT_D);
           break;
        case '4':
          wa147xdem_set_bitrate(DBPSK_400_PROT_D);
          break;
        case '3':
          wa147xdem_set_bitrate(DBPSK_3200_PROT_D);
          break;
        case '2':
          wa147xdem_set_bitrate(DBPSK_25600_PROT_D);
          break;
        case '1':
